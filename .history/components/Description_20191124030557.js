		...
		<DescriptionList
			items={[
				...
				},
				{
					term: 'TODO',
					description:
						'Developed everything specified in the app except for dragging event handlers to support multiple deletes, not enough time! Easily extendible with my global state management pattern. ',
				},
			]}
		/>
	);
