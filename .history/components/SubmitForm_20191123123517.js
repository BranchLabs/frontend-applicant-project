...
function reducer(state, action) {
  switch (action.type) {
    case "ERROR":
      return { ...state, active: true, message: "Not valid json", error: true, inlineError: "The data was not valid JSON" };
    case "ACCEPT":
  ...
  return (
    <Card title='Input' sectioned>
      ...
      <Form onSubmit={handleSubmit}>
        <FormLayout>
          <TextField multiline value={data} onChange={handleDataChange} label='Data key' helpText={<span>Per instructions, this form only supports json.</span>} />
