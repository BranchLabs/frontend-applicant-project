		...
		<DescriptionList
			items={[
				...
				},
				{
					...
					description:
						"I choose React's useReducer and useContext to manage the global state. Any component within the _app.js can access the state (tableData, grid size, current cell) or call a dispatch method to support keyboard navigation, cell updates, or formulas. ",
				},
				{
					term: 'Dependancies',
					description:
